...
namespace OpenSeaDragon
{
    ...
    /// </summary>
    public class OSDTileGenerator
    {

        /// <summary>
        /// Method for tiling the images
        /// </summary>
        ...
        public static bool GenerateTiles(string sourceImagePath, int tileSize = 256, int overlap = 0)
        {
            return new TileGenerator(sourceImagePath, tileSize, overlap).GenerateTiles();
        }

        /// <summary>
        /// Internal class for the Tile Generator
        /// </summary>
        /// <param name="sourceImagePath">Indicates the image resource</param>
        /// <param name="tileSize">Indicates the size of the tiles</param>
        /// <param name="overlap">Overlap</param>
        internal class TileGenerator(string sourceImagePath, int tileSize = 256, int overlap = 0)
        {
            ...
            private readonly string _sourceImage = sourceImagePath;
            ...
            private bool CheckJsonFileName(string name)
            {
